...
/*int iter_dij(int source,int v,vector<pair<int,int>>adj[]){
	bool boolean[v];
...
int astar(int source,int goal, vector<int>adj[],vector<int>heurstic){
...
int main(){
	...
	cout<<"enter heurstic values:\n";
	for (int i = 0; i < v; ++i)
	{
		int x;cin>>x;
		heurstic.push_back(x);
	}
